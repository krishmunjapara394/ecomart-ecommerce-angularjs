...
export class UserServiceService {
  ...
  addCart(data: any, quantity: number = 1): Observable<any> {
    console.log('id ' + data + ' qty ' + quantity);
  ...
  private handleError(error: HttpErrorResponse) {
    ...
    // Re-throw the original error so components can read error.error.message
